...
def get_token(silk_id):
    ...
    return result
def requ(token,servername,methodname,json_data,x_vayne):
...
resp = requ(json_data=data,methodname=methodname,x_vayne=x_vayne,servername=get_servername(methodname),token=token)
